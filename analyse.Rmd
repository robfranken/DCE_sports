...
panelm <- mlogit(choice ~ prestatie + kennis + gezellig + esteem |0,io_ml)

mlogit(choice ~ prestatie + kennis + gezellig + esteem, panel = TRUE, rpar = c(id= "n"), corelation=TRUE, data=io_ml)
...
1. Comparison: respondents prefer a sports partner who places an appropriate amount of emphasis on social comparison — not too much and not too little.
